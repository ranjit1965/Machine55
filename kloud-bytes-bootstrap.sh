...
cat >>/etc/hosts<<EOF
192.168.55.100   k8s55master.example.com     k8s55master  km1
192.168.55.101   k8s55worker1.example.com    k8s55worker1 kw1
192.168.55.102   k8s55worker2.example.com    k8s55worker2 kw2
192.168.55.103   k8s55worker3.example.com    k8s55worker3 kw3
192.168.55.104   k8s55worker4.example.com    k8s55worker4 kw4
EOF
